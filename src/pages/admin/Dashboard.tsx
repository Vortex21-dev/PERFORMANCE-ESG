...
import { ComprehensiveESGManagement } from '../../components/admin/ComprehensiveESGManagement';
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-xl border border-gray-200">
                <div className="px-6 py-4 border-b border-gray-200">
                  <h2 className="text-lg font-semibold text-gray-900">Gestion Complète ESG</h2>
                  <p className="text-sm text-gray-600 mt-1">
                    Assignez et gérez tous les éléments ESG (secteurs, normes, enjeux, critères, indicateurs, processus) pour vos organisations
                  </p>
                </div>
                <div className="p-6">
                  <ComprehensiveESGManagement />
                </div>
              </div>
