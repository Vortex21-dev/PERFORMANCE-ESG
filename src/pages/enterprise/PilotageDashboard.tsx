...
import { BarChart3, Table, Eye, Building2, PieChart, Users } from 'lucide-react';
...
export default function PilotageDashboard() {
  ...
  const [activeView, setActiveView] = useState(() => {
    ...
    // Default to 'admin-pilotage' for enterprise users and admins
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white shadow-sm border-b px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-1 bg-gray-100 rounded-lg p-1">
              <button
                onClick={() => setActiveView('admin-pilotage')}
                className={`flex items-center space-x-2 px-3 py-2 rounded-md transition-colors ${
                  activeView === 'admin-pilotage' 
                    ? 'bg-blue-600 text-white' 
                    : 'text-gray-600 hover:bg-gray-200'
                }`}
              >
                <Users className="w-4 h-4" />
                <span>Pilotage Admin</span>
              </button>
              <button
        ...
        <div className="p-6">
          <motion.div
            ...
            transition={{ duration: 0.2 }}
          >
            {activeView === 'admin-pilotage' && <AdminClientPilotage />}
